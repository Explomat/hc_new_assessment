...
class Tree extends React.Component {
	...
	handleSave(){
		const data = this.state.selected ? this.state.selected.props.data : null;
	...
	handleClick(){
		const out = this.state.selected ? this.state.selected.props.data : '';
	...
	selectNode(node) {
		const isSelected = node.state.selected ? false : true;
		const selectedNode = isSelected ? node : null;
